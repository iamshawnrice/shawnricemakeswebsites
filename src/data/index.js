const data = {
	portfolio: {
		...
		items: {
			handcrafteddelivery: {
				background: 'bg8',
				description:
					'Handcrafted Delivery is a white glove furniture delivery provider for fine furniture makers all throughout New England. This was my first time working with building out forms in WordPress without using plugins. And I must admit, I understand why people tend to go that route. But it was a phenomenal learning experience and I am highly satisfied with how this site turned out. It certainly helps that they partner with some of the best furniture makers in the business and have a trove of great photos to work with.',
				id: 'handcrafteddelivery',
				tags: 'WordPress & Server Migration',
				title: 'handcrafteddelivery.com',
				url: 'http://handcrafteddelivery.com',
				featuredimage:
					'/images/portfolio/handcrafteddelivery/handcrafteddelivery-preview.jpg'
			},
			iamheatherrice: {
				background: 'bg0',
				description:
					'Heather Rice is a singer/songwriter who just released her first full-length album of original music. She is also my wife. She needed a site that was responsive, easy to maintain, and allowed her to build and connect with an audience all over the globe. Designed by the extremely talented <a href="https://dribbble.com/Jonesie">Robert Jones.</a>',
				id: 'iamheatherrice',
				tags: 'WordPress & Bandsintown',
				title: 'iamheatherrice.com',
				url: 'http://iamheatherrice.com',
				featuredimage:
					'/images/portfolio/iamheatherrice/iamheatherrice-preview.jpg'
			},
			oliveoyl: {
				background: 'bg1',
				description:
			...
			isthewalldoneyet: {
				background: 'bg6',
				description:
					'This project served multiple purposes: 1. I wanted to play around with Firebase\'s hosting and real-time database 2. I wanted to experiment with <a href="http://animejs.com/">animejs</a> and 3. I wanted to toss a bit of humor into what continues to be one of the least civil discussions that I have witnessed in my lifetime.',
				id: 'isthewalldoneyet',
				tags: 'Firebase Anime',
				...
				featuredimage:
					'/images/portfolio/isthewalldoneyet/isthewalldoneyet-preview.jpg'
			},
			thebrolodex: {
				background: 'bg2',
				description:
	...
	pages: {
		about: {
			...
			copy:
				'I live in Charleston, SC with my wife (she’s the cute one on the right). We are in charge of feeding and entertaining a black Lab named Red and an orange tabby named CC (though I pretty much universally refer to him as Cecil). We are in the process of fixing up a little house in West Ashley in preparation for the arrival of our first child. You can learn more about me <a href="http://iamshawnrice.com">here</a> and more about Heather <a href="http://iamheatherrice.com">here</a>.'
		},
		introduction: {
			image: {
				file: 'headshot',
